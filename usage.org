...
* Eskimo, Inuit
  In recent years, Eskimo has come to be regarded as offensive (partly through the associations of the now discredited etymology ‘one who eats raw flesh’). The peoples inhabiting the regions from northwestern Canada to western Greenland call themselves Inuit (see usage at Inuit), but in the US, Eskimo is the only term that can be properly applied to all of the peoples as a whole, and it is still widely used in anthropological and archaeological contexts. The broader term Native American is sometimes used to refer to Eskimo and Aleut peoples. See usage at Native American.
